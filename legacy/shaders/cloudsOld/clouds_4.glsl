...
void main(){
    ...
    float cloud = -(
    // Richtige Wolken
        (snoise(st * 2.) + wolkigkeit)*.5

    // Schäfchen, die sich langsam ineinander umformen
        + 1. * (voronoi(st * 9. - seed*2., .3) * 0.6
        + voronoi(st * 16. - seed*2., -.45) * 0.3) 
    ...
    // Feine Strukturen
        + 1. * (snoise(st * 32. + seed*3.)*0.03
        + voronoi(st * 32. + seed*4., .9) * 0.1
        + voronoi(st * 60. + seed*9., -2.) * -0.07)
