...
void main(){
    ...
    float cloud=-(
        ...
        +(voronoi(st*7.-seed*.2,.3)*1.1-.3)
        +voronoi(st*16.-seedX*.2,-.45)*.3
        
        // Weniger Schäfchen, mehr Chaos
        +snoise(st*8.-seed*0.)*.15
        +snoise(st*16.-seed*0.)*.1
        
        // Feine Strukturen
        +snoise(st*32.+seed*0.)*.03
        +voronoi(st*32.+seed*0.,.9)*0.13
        +voronoi(st*60.+seed*0.,-2.)*-.07
