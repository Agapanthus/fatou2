...
export abstract class Fractal {
    ...
    // render a frame
    protected requestFrame: (() => void) | null = null;
    ...
    // software renderer
    abstract sample(pos: Complex, zoom: Complex, lPos: Complex): Color;

    // full render cycle
    abstract fullRender(r: Rect, pos: Complex, zoom: Complex, s: Size): void;
}
